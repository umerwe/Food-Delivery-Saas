            ...
            <div className="relative z-10 w-full max-w-4xl px-4 flex flex-col items-center ml-0 md:ml-20">
                ...
                <div className="bg-white rounded-2xl shadow-xl w-full p-6 md:p-8">
                    ...
                    <div className="flex gap-4 mb-6">
                        <button className="flex items-center gap-2 px-4 py-2 bg-[#F15A2B15] text-primary rounded-lg font-bold">
                            <Bike size={20} />
                            Delivery
                        </button>
                        <button className="flex items-center gap-2 px-4 py-2 text-[#757575] font-bold hover:bg-gray-50 rounded-lg transition-all">
                            <ShoppingBag size={20} />
                            Pickup
                        </button>
                    </div>
